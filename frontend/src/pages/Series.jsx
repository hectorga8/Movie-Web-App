    ...
    <div className="min-h-screen bg-transparent text-white pt-6 pb-20">
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="mt-8 mb-4 flex justify-between items-end border-b border-[#445566] pb-2">
          ...
          <Link to="/series/todas" className="text-[11px] md:text-[13px]  text-[#8aa8c2] hover:text-[#fff] transition-colors">MÁS</Link>
        </div>
        <PopularSeriesWeek />
        ...
        <div className="mt-8 mb-4 flex justify-between items-end border-b border-[#445566] pb-2">
          ...
          <span className="text-[11px] text-[#8aa8c2]">843,460,029 episodios vistos</span>
        </div>
        <JustReviewedSeries />
