        ...
        <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
          ...
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 p-1.5 rounded-[8px] shadow-sm">
             ...
             >
               ...
               <option value="popularity" className="bg-transparent">Por Popularidad</option>
               <option value="rating" className="bg-transparent">Mejor Valoradas</option>
               <option value="newest" className="bg-transparent">Más Recientes (Global)</option>
             </select>
          </div>
        </header>
