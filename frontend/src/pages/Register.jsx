...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) { login(data.user, data.token); navigate('/onboarding'); }
    ...
    <div className="flex-1 flex flex-col items-center justify-center bg-[#111419] py-8 px-6 relative overflow-hidden">
      ...
      <div className="fade-up w-full max-w-[420px] relative z-10">
        ...
        <div className="w-full bg-white/5 backdrop-blur-xl rounded-[12px] overflow-hidden shadow-2xl border border-white/10">
          <div className="h-1.5 w-full bg-[#7b42bc] shadow-[0_0_15px_rgba(123,66,188,0.4)]"></div>
              ...
              <form className="space-y-5 flex flex-col items-center" onSubmit={handleSubmit}>
                ...
                <div className="w-full space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-3 rounded-[8px] bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-[#7b42bc] focus:bg-white/10 transition-all text-center placeholder:text-white/20"
                    required
                  />
                </div>
