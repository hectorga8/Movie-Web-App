        ...
        {series.map((serie, i) => {
          ...
          return (
            <div key={serie.id} className="flex flex-col">
              <Link to={`/serie/${serie.id}`} className="block border border-[#445566] hover:border-[#00e054] rounded-[4px] overflow-hidden transition-colors aspect-[2/3] bg-[#2c3440] relative">
                <img 
