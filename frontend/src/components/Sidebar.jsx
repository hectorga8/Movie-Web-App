// ─────────────────────────────────────────────────────────────
// Sidebar.jsx
// Navegación lateral con colecciones, listas y estadísticas
// ─────────────────────────────────────────────────────────────
      ...
      <div className="md:sticky md:top-24 space-y-8">
            ...
            <a href="#" className="flex items-center justify-between gap-3 px-3 py-2.5 rounded-xl bg-[#283618] text-[#FDFCF7] font-medium transition-all shrink-0">
              <div className="flex items-center gap-3">
                <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10-2a2 2 0 012 2v11a2 2 0 01-2 2h-2a2 2 0 01-2-2V6a2 2 0 012-2h2z"/>
                </svg>
                Todos los libros
              </div>
        ...
        <div className="hidden md:block">
          <h3 className="text-xs font-bold uppercase tracking-[0.15em] text-[#606C38]/60 mb-4 px-3 flex items-center justify-between">
            Mis Listas
            <button className="hover:text-[#BC6C25] transition-colors text-base leading-none" title="Crear nueva lista">+</button>
          </h3>
          <nav className="flex flex-col gap-1">
            <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#283618] hover:bg-[#F4F3ED] font-medium transition-all">
              <svg className="w-[18px] h-[18px] text-[#BC6C25]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
