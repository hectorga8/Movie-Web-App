  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md border-b border-[#606C38]/10 bg-[#FDFCF7]/85">
      <div className="w-full max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between gap-6">
        ...
        {/* Buscador central (Solo en Dashboard) */}
        {variant === "app" && (
          <div className="flex-1 max-w-md hidden md:block">
            <div className="relative">
              ...
              <input
                ...
                class="w-full pl-10 pr-4 py-2.5 rounded-xl bg-[#F4F3ED] border border-[#606C38]/15 text-[#283618] placeholder-[#606C38]/50 text-sm focus:outline-none focus:border-[#606C38]/50 transition-all"
              />
            </div>
          </div>
        )}
        ...
        <nav className="hidden lg:flex items-center gap-1 text-sm shrink-0">
          <a href="#" className="px-3.5 py-2 rounded-lg text-[#283618] hover:bg-[#606C38]/8 font-medium transition-all">Inicio</a>
          <a href="#" className="px-3.5 py-2 rounded-lg text-[#283618] hover:bg-[#606C38]/8 font-medium transition-all">Explorar</a>
          <a href="#" className="px-3.5 py-2 rounded-lg text-[#283618] hover:bg-[#606C38]/8 font-medium transition-all">Mis libros</a>
        </nav>
