...
const reviewsData = [
  {
    author: "sidduw",
    rating: 5,
    text: "\"escuchamos, no juzgamos\" sale mal",
    likes: "51,914",
  ...
  },
  {
    author: "J",
    rating: 3.5,
    text: "Todos mis colegas odian a Rachel",
    likes: "44,610",
  ...
  },
  {
    author: "Nibit",
    rating: 4,
    text: "estaba más sorprendido por la confesión de rachel",
    likes: "26,231",
  ...
  },
  {
    author: "starstruck",
    rating: 4,
    text: "están pasando por cosas que ni siquiera puedes encontrar en reddit",
    likes: "42,113",
  ...
  },
  {
    author: "carley :)",
    rating: 4.5,
    text: "supongo que soy una friki porque no me habría importado",
    likes: "25,477",
  ...
  },
  {
    author: "Yashley",
    rating: 4,
    text: "No puedo esperar a ver si resuelven sus problemas en Dune: Parte Tres",
    likes: "34,009",
    ...
    <div className="flex flex-col">
      {reviewsData.map((review, i) => (
        <div key={i} className="flex gap-4 py-4 border-b border-[#445566] last:border-0">
          <Link to={`/pelicula/${movie?.id}`} className="w-[70px] shrink-0 border border-[#445566] hover:border-[#00e054] rounded-[3px] overflow-hidden transition-colors aspect-[2/3] bg-[#2c3440]">
            {movie && (
              <img 
